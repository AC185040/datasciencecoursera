---
title: "README_Getting&CleaningDataAssignmnt"
author: "AC185040"
...
Download the original data
  ...
  project under the directory: D:/Data Science/getting&CleaningData  and then doenloads, unzips all
  relevant datafile in this folder: D:/Data Science/getting&CleaningData/project
  
how to run the analysis
  
  In your R enviroment,  set your working directory to be: 
...
final tidy dataset
  Each row in the final, clean dataset contains subject, activity, and measures for all 
  required features (i.e., mean or standard deviation).
